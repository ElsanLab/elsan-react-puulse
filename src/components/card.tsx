...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("ep:leading-none ep:font-semibold", className)}
      {...props}
    />
  )
}
...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("ep:px-6", className)}
      {...props}
    />
  )
}
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("ep:flex ep:items-center ep:px-6 ep:[.border-t]:pt-6", className)}
      {...props}
    />
  )
}
