...
var p = (o, l) => w(o, "name", { value: l, configurable: !0 });
    ...
    v,
    {
      ...
      classNames: {
        ...
        caption_label: e(
          ...
          u === "label" ? "ep:text-sm" : "ep:rounded-md ep:pl-2 ep:pr-1 ep:flex ep:items-center ep:gap-1 ep:text-sm ep:h-8 ep:[&>svg]:text-muted-foreground ep:[&>svg]:size-3.5",
          t.caption_label
        ),
      ...
      components: {
        Root: /* @__PURE__ */ p(({ className: a, rootRef: d, ...s }) => /* @__PURE__ */ n(
          "div",
          {
            "data-slot": "calendar",
            ref: d,
        ...
        Chevron: /* @__PURE__ */ p(({ className: a, orientation: d, ...s }) => d === "left" ? /* @__PURE__ */ n(
          y,
          {
