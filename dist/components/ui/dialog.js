...
function k({
  ...
  return /* @__PURE__ */ a(
    l.Title,
    {
      ...
      className: i("ep:text-lg ep:leading-none ep:font-semibold", e),
      ...t
    }
  );
}
...
function T({
  ...
  return /* @__PURE__ */ a(
    l.Description,
    {
      ...
      className: i("ep:text-muted-foreground ep:text-sm", e),
      ...t
    }
  );
}
o(T, "DialogDescription");
export {
  b as Dialog,
  y as DialogClose,
  z as DialogContent,
